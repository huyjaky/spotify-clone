                ...
                return (
                  <tr className="hover:bg-CellColorHover h-fit hover:rounded-2xl">
                    ...
                    <td>
                      <div className="flex">
                        <img
                          src={`${item.track.album.images[0] ? item.track.album.images[0].url : 'https://e7.pngegg.com/pngimages/239/995/png-clipart-spotify-computer-icons-streaming-media-listen-on-spotify-hand-logo.png'}`}
                          alt=""
                          className="h-20 w-20 object-cover"
                        />
                        <div className="ml-6">
                          {/* name song */}
                          <div className="w-full h-[50%] text-[20px] font-semibold whitespace-nowrap
